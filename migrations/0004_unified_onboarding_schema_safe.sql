-- Migration: Unified Onboarding Schema (Safe)
-- This migration creates the unified onboarding system safely
-- Date: January 2025

-- Step 1: Safely clean up any existing objects (only if they exist)
DO $$ 
BEGIN
