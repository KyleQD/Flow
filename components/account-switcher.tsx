...
import { ChevronDown, Plus, Settings, User, Music, Building, Shield, Crown } from 'lucide-react'
          ...
          {userAccounts.map((account) => {
            ...
            return (
              <DropdownMenuItem
                ...
                onClick={() => !isActive && handleAccountSwitch(account.profile_id, account.account_type)}
              >
                <div className="relative">
