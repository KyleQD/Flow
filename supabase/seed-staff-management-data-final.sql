...
-- This script uses correct job_type values with hyphens and proper column names
...
BEGIN
  ...
  IF venue_record.id IS NOT NULL THEN
    ...
    INSERT INTO staff_jobs (
      ...
      'Technical',
      'Main Venue',
      'full-time',  -- Fixed: hyphen instead of underscore
      65000.00,
      80000.00,
      'high',
    ...
    INSERT INTO staff_jobs (
      ...
      'Security',
      'All Venue Areas',
      'part-time',  -- Fixed: hyphen instead of underscore
      18.00,
      25.00,
      'medium',
    ...
    -- =============================================================================
    -- 4. SAMPLE ONBOARDING CANDIDATE (Fixed employment_type)
    -- =============================================================================
