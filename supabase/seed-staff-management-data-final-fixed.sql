-- =============================================================================
-- FINAL FIXED SAMPLE DATA FOR STAFF MANAGEMENT & JOB BOARD SYSTEM
-- This script uses correct status values that match existing check constraints
...
BEGIN
  ...
  IF venue_record.id IS NOT NULL THEN
    ...
    -- =============================================================================
    -- 1. SAMPLE JOB POSTINGS (Using correct job_type values with hyphens)
    -- =============================================================================
    ...
    -- =============================================================================
    -- 2. SAMPLE JOB APPLICATIONS (Using only allowed status values)
    -- =============================================================================
    ...
    INSERT INTO staff_applications (
      ...
      'Immediate',
      'accepted',  -- Fixed: using allowed status value
      5,
      92
    ...
    INSERT INTO staff_applications (
      ...
      'Immediate',
      'pending',  -- Fixed: using allowed status value
      4,
      85
    ...
    -- Update application status for hired candidate (using allowed status value)
    UPDATE staff_applications SET status = 'accepted', hired_date = NOW()::DATE WHERE id = app_1_id;
