-- =============================================================================
-- SIMPLIFIED STAFF MANAGEMENT TABLES ONLY
-- This version creates just the essential tables without storage policies
-- Use this if you're getting type casting errors
-- =============================================================================
...
BEGIN
  RAISE NOTICE '=================================================';
  RAISE NOTICE '✅ SIMPLIFIED STAFF TABLES CREATED SUCCESSFULLY!';
  RAISE NOTICE '=================================================';
  RAISE NOTICE 'Created tables without storage policies:';
  ...
  RAISE NOTICE '';
  RAISE NOTICE '🎯 No type casting errors - ready for seed data!';
  RAISE NOTICE '=================================================';
END $$; 