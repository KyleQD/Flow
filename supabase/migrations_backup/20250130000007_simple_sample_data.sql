-- =============================================================================
-- SIMPLE SAMPLE DATA - WORKS AFTER SCHEMA FIX
-- This migration adds sample data after the schema is properly set up
-- Migration: 20250130000007_simple_sample_data.sql
-- =============================================================================
...
BEGIN
    ...
    RAISE NOTICE 'Tours inserted successfully';
END $$;
...
VALUES ('SAMPLE_DATA_CREATED', 'migration', NULL, '{"migration": "20250130000007_simple_sample_data.sql", "tables_populated": "all_admin_tables", "status": "success"}');
