-- =============================================================================
-- FIXED SAMPLE DATA FOR ADMIN PLATFORM TESTING
-- This migration adds sample data using correct column names
-- Migration: 20250130000003_fixed_sample_data.sql
-- =============================================================================

-- Sample tours data (using correct column names)
INSERT INTO tours (name, description, status, start_date, end_date, total_shows, completed_shows, budget, expenses, revenue, transportation, accommodation, equipment_requirements, crew_size) VALUES
('Summer Festival Tour 2024', 'A nationwide summer festival tour featuring multiple artists', 'active', '2024-06-01', '2024-08-31', 25, 8, 500000.00, 125000.00, 750000.00, 'Bus and van transportation', 'Hotel accommodations', 'Full sound and lighting rig', 12),
('Winter Arena Tour', 'Large arena tour across major cities', 'planning', '2024-12-01', '2025-02-28', 15, 0, 750000.00, 0.00, 0.00, 'Private jet and buses', 'Luxury hotels', 'Advanced stage setup', 20),
('Club Circuit 2024', 'Small venue club tour', 'completed', '2024-03-01', '2024-05-31', 30, 30, 150000.00, 140000.00, 300000.00, 'Van transportation', 'Budget hotels', 'Basic sound system', 6)
ON CONFLICT DO NOTHING;

-- Sample events data (using correct column names)
...
VALUES ('SAMPLE_DATA_CREATED', 'migration', NULL, '{"migration": "20250130000003_fixed_sample_data.sql", "tables_populated": "all_admin_tables", "status": "success"}'); 