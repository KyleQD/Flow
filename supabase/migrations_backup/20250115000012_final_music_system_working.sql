-- =============================================
-- Final Working Music System Migration
-- =============================================
...
-- Drop all music-related triggers
...
-- Enable RLS for artist_profiles
ALTER TABLE artist_profiles ENABLE ROW LEVEL SECURITY;

-- Create basic policies for artist_profiles
...
-- =============================================
-- HELPER FUNCTIONS (CREATED AFTER ALL TABLES AND TRIGGERS)
-- =============================================
