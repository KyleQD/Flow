-- =============================================================================
-- FINAL SAMPLE DATA FOR ADMIN PLATFORM TESTING
-- This migration adds sample data with proper constraint handling
-- Migration: 20250130000005_final_sample_data.sql
-- =============================================================================

-- First, get a valid user ID for artist_id references
DO $$
DECLARE
    valid_user_id UUID;
BEGIN
    ...
    -- If no profiles exist, create a dummy one or use a default
    IF valid_user_id IS NULL THEN
        -- Create a dummy profile for testing if none exists
    ...
    -- Sample tours data (using valid artist_id)
    INSERT INTO tours (name, description, artist_id, status, start_date, end_date, total_shows, completed_shows, budget, expenses, revenue, transportation, accommodation, equipment_requirements, crew_size) VALUES
...
VALUES ('SAMPLE_DATA_CREATED', 'migration', NULL, '{"migration": "20250130000005_final_sample_data.sql", "tables_populated": "all_admin_tables", "status": "success"}'); 