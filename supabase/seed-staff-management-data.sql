-- =============================================================================
-- SAMPLE DATA FOR STAFF MANAGEMENT & JOB BOARD SYSTEM
...
BEGIN
  ...
  IF venue_record.id IS NOT NULL THEN
    ...
    INSERT INTO staff_jobs (
      ...
      job_type, salary_range_min, salary_range_max, salary_type, priority,
      requirements, required_skills, preferred_skills, certifications_required,
      benefits, status, deadline, applications_count
    ) VALUES (
      venue_record.id,
      ...
      ARRAY['Dante Networks', 'Wireless Systems', 'Recording'],
      ARRAY['Audio Engineering Certification', 'OSHA Safety Certification'],
    ...
    INSERT INTO staff_jobs (
      ...
      ARRAY['Event Security Experience', 'CPR Certification'],
      ARRAY['Security License', 'First Aid Certification'],
    ...
    INSERT INTO staff_jobs (
      ...
      ARRAY['Budget Management', 'Marketing', 'Social Media'],
      ARRAY[],
    ...
    INSERT INTO staff_onboarding_templates (
      ...
      required_documents, assignees, tags, is_default, use_count
    ) VALUES (
      venue_record.id,
    ...
    -- =============================================================================
    -- 7. UPDATE APPLICATION COUNTS
    -- =============================================================================
    
    -- Update job posting application counts
    UPDATE staff_jobs SET applications_count = 1 WHERE id IN (job_1_id, job_2_id, job_3_id);

    -- Update application statuses for hired candidate
    UPDATE staff_applications SET status = 'hired', hired_date = NOW() WHERE id = app_1_id;
