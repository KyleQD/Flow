-- Clean Site Map Migration Script
-- This script safely applies the site map system without policy conflicts
...
-- Now apply the main migration
-- This will be the content from the main migration file
-- (The actual migration content would go here)
...
DO $$
BEGIN
    RAISE NOTICE 'Site map system migration completed successfully!';
END $$;
