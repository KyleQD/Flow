...
import { Plus, Trash2, Pencil, Search, Filter, Calendar, MapPin } from "lucide-react"
...
export function EventsDashboard({ userId }: { userId: string }) {
  ...
  async function handleCreateEvent(data: EventWizardMainData) {
    try {
  ...
  async function handleUpdateEvent(eventId: string, data: EventWizardMainData) {
    try {
