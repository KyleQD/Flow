...
export default function OptimizedArtistDashboard() {
              ...
              <div className="flex items-center space-x-2">
                <div className="relative flex-1 lg:flex-none">
                  ...
                  <Input
                    ...
                    className="pl-10 w-full lg:w-[200px] bg-slate-800/50 border-slate-700/50 text-white focus:border-purple-500/50 focus:ring-purple-500/20"
                  />
                </div>
              </div>
